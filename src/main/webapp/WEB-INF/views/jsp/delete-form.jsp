    ...
    <div class="table-title mb-4">
        <div class="row">
            ...
            <div class="col-sm-6 mt-3 text-right">
                <a href="/SpringManagerProduct" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <span>Product list</span></a>
            </div>
        </div>
    </div>
    <form:form id="frmCreateCustomer" action="/SpringManagerProduct/delete-product" method="post" modelAttribute="product" >
